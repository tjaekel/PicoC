...
#undef NO_CALLOC
#undef NO_REALLOC
#undef  NO_STRING_FUNCTIONS     //with malloc and str functions
#define  USE_PLATFORM_LIB
...
#define	MAX_SCRIPT_SIZE	4096	//size of text script files loaded/sent via UART
...
enum BaseType
{
    ...
    TypeUnsignedLongLong,       /* unsigned long long for 64bit platform */
#ifndef NO_FP
