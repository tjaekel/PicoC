...
#else
#define HEAP_SIZE (1024*1024*8)                 /* spave for the heap and the stack, 1MB * x */
#endif
...
typedef long                PRT_TYPE_INT_SIGNED;
#else
typedef unsigned long long	PTR_TYPE_INT;
typedef long long           PTR_TYPE_INT_SIGNED;
#endif
